...
from attacks import BIM, FGSM, PGD, MI_RandomWeight, \
    ...
    DI_MI_FGSM, MI_TI_FGSM, VMI_Inner_CommonWeakness, VMI_FGSM, VMI_Outer_CommonWeakness
from models import *
import torch
...
origin_train_models = [
                        BaseNormModel(resnet18(pretrained=True)),
                       BaseNormModel(resnet34(pretrained=True)),
                       BaseNormModel(resnet50(pretrained=True)),
                       BaseNormModel(inception_v3(pretrained=True)),
                       Salman2020Do_R50(),
...
attacker_list = [VMI_Outer_CommonWeakness]
