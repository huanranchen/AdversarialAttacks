...
from .utils import str2bool, get_accuracy, get_image_classifier, load_data, Logger, dict2namespace
...
def parse_args_and_config_imagenet():
    ...
    # parse config file
    with open(os.path.join('./defenses/PurificationDefenses/DiffPure/configs', args.config), 'r') as f:
